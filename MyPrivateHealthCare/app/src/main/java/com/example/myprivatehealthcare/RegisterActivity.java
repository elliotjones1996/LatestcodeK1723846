...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edConfirm = findViewById(R.id.editTextRegAppFees);
                ...
                if (username.length() == 0 || email.length() == 0 || password.length() == 0 || confirm.length() == 0) {
                    ...
                    if (password.compareTo(confirm) == 0) {
                        if (isValid(password)) {
                            ...
                            Toast.makeText(getApplicationContext(), "Password must contain at least 8 characters, have a letter, digit,special symbol", Toast.LENGTH_SHORT).show();
                        }
                    }else{
